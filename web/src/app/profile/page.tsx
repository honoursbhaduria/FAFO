    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
          <div className="w-32 h-32 bg-blue-100 rounded-3xl flex items-center justify-center text-blue-600 text-4xl font-bold border-4 border-blue-50 shadow-inner">
            {profile?.businessName?.[0] || "O"}
          </div>
          <div className="flex-1">
            <div className="flex flex-col md:flex-row md:items-center gap-3 mb-2">
              <h1 className="text-3xl font-extrabold text-slate-900">{profile?.businessName || "Your Business Name"}</h1>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3">
              <button className="px-6 py-2.5 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">
                Edit Profile
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="px-8 py-6 border-b border-slate-50">
                <h2 className="text-xl font-bold text-slate-900">Categories & Ownership</h2>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
              ...
              <button className="w-full text-left py-2 text-sm font-semibold text-slate-600 hover:text-blue-600 transition-colors">
                Change Password
              </button>
              <button className="w-full text-left py-2 text-sm font-semibold text-slate-600 hover:text-blue-600 transition-colors">
                Two-Factor Auth
